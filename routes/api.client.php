...
Route::get('channels/{encoded_id}', '\GetCandy\Api\Core\Channels\Actions\FetchChannel');
Route::get('collections', 'Collections\CollectionController@index');
Route::get('collections/{id}', 'Collections\CollectionController@show');
...
Route::group([
    ...
    Route::get('{encoded_id}', '\GetCandy\Api\Core\Customers\Actions\FetchCustomer');
    Route::put('{encoded_id}', '\GetCandy\Api\Core\Customers\Actions\UpdateCustomer');
    Route::post('/', '\GetCandy\Api\Core\Customers\Actions\CreateCustomer');
});
